...
INSERT INTO anuncios (titulo, descricao, preco, miniatura, ativo, prazo, id_usuario)
VALUES 
('Camisa', 'Camisas com imagens aleatórias a seu pedido', 20.00, 'https://www.google.com/url?sa=i&url=https%3', 1, 15, 2),
('Bermuda', 'Bermudas jeans, moletom.', 60.00, 'https://www.google.com/ur', 1, 15, 3),
('Jogos', 'de ps4, xbox usados', 120.00, 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fstatic.netshoes.com.br%2Fprodutos%2', 1, 5, 1),
('Formatação de PC', 'Formato computadores, notebooks etc...', 50.00, 'umlinkqualquer', 1, 7, 1);

insert into produtos(id_anuncio, id_tipoProduto)
VALUES
(1, 2),
(2, 2),
(3, 1);

insert into servicos(id_anuncio, id_tipoServico)
VALUES
(4, 1);
